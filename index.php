...
<body>
    ...
    <header >
        ...
        <div class="logo_name">
            <div><a href="pages/pageAccueil.php"><img src="photo/icon_koundoul_Shop.ico" alt="Logo de Koundoul Shop" class="logo" ></a></div>
            <h1><a href="pages/pageAccueil.php">KOUNDOUL SHOP</a></h1>
        </div>
        <div>
            <nav>
                <ul class="link_button_position">
                    <li><a href="pages/pageAccueil.php">Accueil</a></li>
                    <li><a href="pages/pageVetement.php"></i> Vêtements</a></li>
                    <li><a href="pages/pageAccessoires.php"></i> Accessoires</a></li>
                    <li><a href="pages/pageChaussures.php"></i> Chaussures</a></li>
        ...
        <div>
            <ul class="link_button_position">
                ...
                <li><a href="pages/pagePanier.php"><i class="fas fa-shopping-cart"></i></a></li>
            </ul>
        </div>
        ...
        <div id="mobile-menu" class="mobile-menu">
            ...
            <div>
                <ul class="mobile-menu_link">
                    <li><a href="pages/pageAccueil.php"><i class="fas fa-home"></i> Accueil</a></li>
                    <li><a href="pages/pageVetement.php"><i class="fas fa-tshirt"></i> Vêtements</a></li>
                    <li><a href="pages/pageAccessoires.php"><i class="fas fa-cogs"></i> Accessoires</a></li>
                    <li><a href="pages/pageChaussures.php"><i class="fas fa-shoe-prints"></i> Chaussures</a></li>
                    <li><a href="pages/pagePanier.php"><i class="fas fa-shopping-cart"></i> Panier</a></li>
                </ul>
            </div>
            <div>
                <ul>
        ...
        <div class="container_galery reveal">
            <div class="container_galery_div reveal">
                <div class="container_galery_div_pic">
                    <a href="pages/pageVetement.php"><img src="photo/vetements/t-shirt/T-SHIRT.jpg" alt="PIC T-SHIRT" ></a>
                </div>
                <div class="container_galery_div_link">
                    <a href="pages/pageVetement.php">
            ...
            <div class="container_galery_div reveal">
                <div class="container_galery_div_pic">
                    <a href="pages/pageVetement.php"><img src="photo/vetements/tenu/ENSEMBLE.jpg" alt="PIC ENSEMBLE" ></a>
                </div>
                <div class="container_galery_div_link">
                    <a href="pages/pageVetement.php">
                        <button>DÈCOUVRIR</button>
            ...
            <div class="container_galery_div reveal">
                <div class="container_galery_div_pic">
                    <a href="pages/pageAccessoires.php"><img src="photo/accessoires/accessoires-1.jpg" alt="PIC Accessoires" ></a>
                </div>
                <div class="container_galery_div_link">
                    <a href="pages/pageAccessoires.php">
                        <button>DÈCOUVRIR</button>
                    </a>
                </div>
            </div>
            <div class="container_galery_div reveal">
                <div class="container_galery_div_pic">
                    <a href="pages/pageChaussures.php"><img src="photo/chaussures/chaussures-11.jpg" alt="PIC Chaussures" ></a>
                </div>
                <div class="container_galery_div_link">
                    <a href="pages/pageChaussures.php">
                        <button>DÈCOUVRIR</button>
                    </a>
                </div>
            </div>
